...
class EventDetailsLandscapeTablet extends StatelessWidget {
  final int eventId;
  final double width;
  const EventDetailsLandscapeTablet({super.key, required this.eventId, required this.width});
                    ...
                    child: CustomScrollView(
                      slivers: <Widget>[
                        SliverAppBar(
                          ...
                          title: const ReusableText(text: 'Event Details',color: Colors.white,fontSize: 40,),
                          actions: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: BackdropFilter(
                                  ...
                                  child:
                                  const Icon(Icons.bookmark, size: 40,color: Colors.white,),),
                              ),
                            ),
                          ],
                          expandedHeight: 350.0, // Adjust the expanded height as needed
                          floating: false,
                          pinned: true,
                          flexibleSpace: Stack(
                            children: [
