...
class EventSearchLandscapeTablet extends StatelessWidget {
  final double height;
  final double width;
  final TextEditingController searchController;
   EventSearchLandscapeTablet({super.key, required this.height, required this.width, required this.searchController});
        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
              ...
              title: const ReusableText(text:'Search',fontSize: 40,color: AppColors.kPrimaryTextColor,),
              stretch: true,
              floating: true,
              pinned: false,
              snap: true,
