...
class EventSearchPortrait extends StatelessWidget {
  final double height;
  final double width;
  final TextEditingController searchController;
   EventSearchPortrait({super.key, required this.searchController, required this.height, required this.width});
        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
              ...
              title: const ReusableText(text:'Search',fontSize: 24,color: AppColors.kPrimaryTextColor,),
              stretch: true,
              floating: true,
              pinned: false,
              snap: true,
