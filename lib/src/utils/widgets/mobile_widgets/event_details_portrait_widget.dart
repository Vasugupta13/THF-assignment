...
class EventDetailPortraitWidget extends StatelessWidget {
  final int eventId;
  final double width;
  const EventDetailPortraitWidget({super.key, required this.eventId, required this.width});
