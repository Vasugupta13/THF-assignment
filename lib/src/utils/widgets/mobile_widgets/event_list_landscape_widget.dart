...
class EventListLandscape extends StatelessWidget {
  final double height;
  final double width;
   EventListLandscape({super.key, required this.height, required this.width});
        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
              ...
              backgroundColor: const Color(0xfffefefe),
              title: const ReusableText(text: 'Events',fontSize: 28,),
              stretch: true,
              floating: true,
              pinned: false,
              snap: true,
              actions: [
                IconButton(
                  icon: const ImageIcon(ExactAssetImage('assets/icons/search.png'),color: AppColors.kPrimaryTextColor,size: 30,),
                  onPressed: () {
                ...
                PopupMenuButton(
                  ...
                  itemBuilder: (context) {
                    ...
                    return [
                      const PopupMenuItem(
                        value: 'Option 1',
                        child: ReusableText(text: 'Option 1',fontWeight: FontWeight.w400,fontSize: 18,),
                      ),
                      const PopupMenuItem(
                        value: 'Option 2',
                        child: ReusableText(text: 'Option 2',fontWeight: FontWeight.w400,fontSize: 18,),
                      ),
                    ];
                  },
                ),
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ReusableText(text: formattedDate,color:AppColors.kPrimaryBlue,fontSize: 16,fontWeight: FontWeight.w400,),
                                          SizedBox(
                                            height: height * 0.01,
                                          ),
                                          ReusableText(text: event.title!,color: AppColors.kPrimaryTextColor,fontSize: 18,fontWeight: FontWeight.w500,softWrap: true,),
                                          SizedBox(
                                            height: height * 0.03,
                                          ),
                                          Row(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              const Icon(Icons.location_on_rounded,color: AppColors.kSecondaryTextColor,size:21,),
